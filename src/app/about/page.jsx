        ...
        <div className="min-h-screen  dark:bg-gray-900">
            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="mb-16">
                    ...
                    <p className="text-lg text-base-content/70 leading-relaxed mb-4">
                ...
                {/* What We Offer */}
                <div className="mb-16">
                    <h2 className="text-3xl font-bold text-base-content mb-8">What We Offer</h2>
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-base-200 p-3 rounded-lg">
                            <h3 className="text-base font-semibold text-base-content mb-1">Expert-Led Courses</h3>
                        ...
                        <div className="bg-base-200 p-3 rounded-lg">
                            <h3 className="text-base font-semibold text-base-content mb-1">Flexible Learning</h3>
                            <p className="text-base-content/70 text-xs">
                        ...
                        <div className="bg-base-200 p-3 rounded-lg">
                            <h3 className="text-base font-semibold text-base-content mb-1">Practical Projects</h3>
                            <p className="text-base-content/70 text-xs">
                        ...
                        <div className="bg-base-200 p-3 rounded-lg">
                            <h3 className="text-base font-semibold text-base-content mb-1">Community Support</h3>
                            <p className="text-base-content/70 text-xs">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold text-base-content mb-3">Quality First</h3>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold text-base-content mb-3">Accessibility</h3>
                            <p className="text-base-content/70">
                ...
                {/* Contact CTA */}
                <div className="text-center bg-base-200 rounded-2xl p-8">
                    <h2 className="text-3xl font-bold text-base-content mb-4">Ready to Start Learning?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a 
                            href="/contact" 
                            className="border-2 border-base-300 text-base-content px-8 py-3 rounded-full font-semibold hover:border-blue-600 dark:hover:border-blue-400 transition-colors"
                        >
                            Contact Us
                        </a>
                    </div>
