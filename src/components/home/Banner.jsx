    ...
    <div className="absolute inset-0 overflow-hidden">
      ...
      >
        ...
        <motion.circle
          ...
          r="50"
          fill="url(#grad1)"
          animate={{ y: [-15, 20, -15], x: [-5, 8, -5], scale: [1, 1.1, 1] }}
        ...
        <motion.circle
          ...
          r="35"
          fill="url(#grad2)"
          animate={{ y: [15, -20, 15], x: [8, -6, 8], scale: [1, 0.9, 1] }}
        ...
        <motion.circle
          ...
          r="60"
          fill="url(#radial1)"
          animate={{ y: [-20, 25, -20], x: [10, -12, 10], scale: [1, 1.2, 1] }}
        ...
        <motion.circle
          ...
          r="25"
          fill="url(#grad3)"
          animate={{ y: [10, -15, 10], x: [-6, 9, -6], scale: [1, 1.3, 1] }}
        ...
        <motion.rect
          ...
          rx="15"
          fill="url(#grad2)"
          animate={{ y: [8, -12, 8], rotate: [0, 10, 0], scale: [1, 1.05, 1] }}
        ...
        <motion.rect
          ...
          rx="12"
          fill="url(#grad1)"
          animate={{ y: [-10, 12, -10], rotate: [0, -8, 0], scale: [1, 0.95, 1] }}
        ...
        <motion.rect
          ...
          rx="10"
          fill="url(#grad3)"
          animate={{ y: [5, -8, 5], rotate: [0, 15, 0], scale: [1, 1.1, 1] }}
        ...
        <motion.path
          ...
          animate={{ strokeDashoffset: [0, -150], opacity: [0.3, 0.7, 0.3] }}
        ...
        <motion.path
          ...
          animate={{ strokeDashoffset: [0, 200], opacity: [0.2, 0.6, 0.2] }}
...
export default function Banner() {
  ...
  return (
    <section className="relative min-h-[70vh] sm:h-[70vh] mt-17 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-indigo-900/20 overflow-hidden flex items-center">
      ...
      <motion.div
        ref={containerRef}
        className="relative z-10 container mx-auto px-4 sm:px-6 md:px-20 py-12 sm:py-16 md:py-20 h-full flex items-center"
        ...
        <div className="w-full flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.span
              ...
              animate={{ backgroundSize: ["100% 100%", "150% 150%", "100% 100%"] }}
          ...
          {/* Subtitle */}
          <p className="text-gray-700 dark:text-gray-200 mb-8 text-base sm:text-lg md:text-xl max-w-2xl leading-relaxed font-medium">
          ...
          <motion.div className="flex flex-col sm:flex-row gap-4 sm:gap-6" variants={itemVariants}>
            <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
              <Link
                href="/courses"
                className="relative px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white rounded-xl font-semibold text-base sm:text-lg shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group"
              >
            ...
            <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
              <Link
                href="/register"
                className="relative group px-6 sm:px-8 py-3 sm:py-4 border-2 border-sky-600 text-sky-700 dark:text-sky-300 dark:border-sky-400 rounded-xl font-semibold text-base sm:text-lg hover:bg-sky-600 hover:text-white dark:hover:bg-sky-500 transition-all duration-300 backdrop-blur-sm bg-white/20 overflow-hidden"
              >
          ...
          {/* Stats */}
          <motion.div
            className="mt-10 sm:mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 w-full max-w-xl"
            variants={itemVariants}
          >
            {[
              ...
              >
                ...
                />
                <motion.div
                  className="text-xl sm:text-2xl font-bold text-sky-700 dark:text-sky-300 mb-1 relative z-10"
                  initial={{ opacity: 0, scale: 0 }}
                  animate={{ opacity: 1, scale: 1 }}
                  whileHover={{ scale: 1.1, color: "#0284c7" }}
                  transition={{ delay: 0.5 + index * 0.1, duration: 0.5, hover: { duration: 0.2 } }}
                >
                  {stat.number}
                </motion.div>
